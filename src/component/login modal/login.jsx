            ...
            <div className="login-modal">
                ...
                <form className="form-login">
                    <div className="username-input">
                        ...
                        <input type="text" placeholder="type username here..." className="username-input-form  mb-3"/>
                    </div>
                    <div className="password-input">
                        <div className="password-tag">
                            Password
                        </div>
                        <input type="password" className="password-input-form mb-4" placeholder="type password here..."/>
                    </div>
